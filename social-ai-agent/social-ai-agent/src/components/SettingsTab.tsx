    ...
    <div className="space-y-6 animate-fade-in max-w-2xl">
      ...
      <div className="glass rounded-xl p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-semibold text-text" style={{ fontFamily: 'var(--font-display)' }}>Anthropic API Key</h3>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <a href="https://console.anthropic.com/account/keys" target="_blank" rel="noopener noreferrer"
              ...
              Get API key from console.anthropic.com <ExternalLink size={11} />
            </a>
          ...
          <div className="rounded-xl p-3 text-xs" style={{ background: '#0A0A0F', border: '1px solid #1E1E2E', color: '#8888AA' }}>
            💡 <strong className="text-text">For local development:</strong> Add <code className="px-1 py-0.5 rounded" style={{ background: '#1E1E2E' }}>ANTHROPIC_API_KEY=sk-ant-...</code> to your <code className="px-1 py-0.5 rounded" style={{ background: '#1E1E2E' }}>.env.local</code> file. The key is never stored in the browser.
          </div>
        </div>
      </div>
